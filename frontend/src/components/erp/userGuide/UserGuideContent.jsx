    ...
    <div className="space-y-6" data-testid="guide-overview">
      <div className="rounded-2xl border border-[var(--glass-border)] bg-gradient-to-br from-sky-500/10 via-emerald-500/5 to-violet-500/10 p-6">
        <div className="flex items-start gap-4">
          <div className="w-14 h-14 rounded-2xl bg-foreground/[0.01]0 border border-foreground/[0.02]0 grid place-items-center shrink-0">
            ...
            return (
              <div key={key} className={`rounded-xl border p-4 ${m.classes.bg} ${m.classes.border}`}>
                <div className="flex items-start gap-3">
                  <div className={`w-10 h-10 rounded-xl bg-foreground/[0.03]0 dark:bg-foreground/[0.01]0 grid place-items-center shrink-0 ${m.classes.text}`}>
  ...
  return (
    <div className="space-y-5" data-testid={`guide-${portal.id}`}>
      <div className={`rounded-2xl border p-5 ${meta.classes.bg} ${meta.classes.border}`}>
        <div className="flex items-start gap-4">
          <div className={`w-12 h-12 rounded-xl bg-foreground/[0.03]0 dark:bg-foreground/[0.01]0 grid place-items-center shrink-0 ${meta.classes.text}`}>
