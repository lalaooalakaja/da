...
const STATUS_CONF = {
  draft:     { label: 'Draft',     cls: 'bg-muted dark:bg-zinc-500/15 text-muted-foreground/60 dark:text-zinc-400 border-border dark:border-zinc-500/30',     Icon: Clock },
  ...
  cancelled: { label: 'Batal',     cls: 'bg-muted dark:bg-zinc-500/15 text-muted-foreground/60 dark:text-zinc-400 border-border dark:border-zinc-500/30',     Icon: XCircle },
};
