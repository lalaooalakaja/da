          ...
          <div className="space-y-4" data-testid="bulk-po-modal">
            ...
            <div>
              ...
              <button
                ...
                className="flex items-center gap-2 text-sm text-foreground/70 hover:text-foreground px-4 py-2 bg-foreground/5 rounded-lg border border-dashed border-foreground/20 hover:border-foreground/[0.04]0 transition-colors w-full justify-center"
