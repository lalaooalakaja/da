...
export const PORTAL_ROLES = {
  ...
  production:     ['supervisor_produksi', 'admin_produksi', 'operator', 'spv_cuting', 'operator_cuting', 'supervisor'],
  ...
  maklon:         ['admin_maklon', 'admin_produksi', 'supervisor_produksi', 'accounting'],
