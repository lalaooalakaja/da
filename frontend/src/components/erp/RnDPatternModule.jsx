            ...
            <tbody>
              {paged.map(p => (
                <tr key={p.id} className="border-b border-foreground/5 hover:bg-foreground/[0.03]">
                  ...
                  <td className="px-4 py-3">
                    <span className={`text-xs px-2 py-0.5 rounded-full border ${STATUS_COLOR[p.status] || 'bg-muted dark:bg-zinc-500/20 text-muted-foreground/60 dark:text-zinc-500 border-border dark:border-zinc-500/30'}`}>
