...
const STATUS_STYLE = {
  ...
  archived: { label: 'Arsip',   cls: 'bg-muted dark:bg-zinc-500/20 text-muted-foreground/60 dark:text-zinc-400 border-border dark:border-zinc-500/30' },
...
const STATUS_SAMPLE = {
  draft:     { label: 'Draft',     cls: 'bg-muted dark:bg-zinc-500/20 text-muted-foreground/60 dark:text-zinc-400 border-border dark:border-zinc-500/30', Icon: Clock },
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <span className={`text-xs px-2 py-0.5 rounded-full border ${
                                tp.status === 'approved' ? 'bg-emerald-100 dark:bg-emerald-500/20 text-emerald-500 border-emerald-400 dark:border-emerald-500/30'
                                  : tp.status === 'superseded' ? 'bg-muted dark:bg-zinc-500/20 text-muted-foreground/60 dark:text-zinc-400 border-border dark:border-zinc-500/30'
                                  : 'bg-amber-100 dark:bg-amber-500/20 text-amber-700 dark:text-amber-500 border-amber-400 dark:border-amber-500/30'
