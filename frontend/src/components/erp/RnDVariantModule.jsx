...
const STATUS_COLOR = {
  ...
  archived: 'bg-muted dark:bg-zinc-500/20 text-muted-foreground/60 dark:text-zinc-500 border-border dark:border-zinc-500/30',
};
              ...
              <div className="flex items-start justify-between">
                ...
                <div className="flex gap-2">
                  ...
                  <Button variant="ghost" size="sm" onClick={() => setDelId(v.id)}
                    className="h-8 w-8 p-0 text-red-700 dark:text-red-500 hover:text-red-700 dark:text-red-500 hover:bg-red-100 dark:bg-red-500/10"
      ...
      <Modal open={showForm} onClose={() => setShowForm(false)}
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <Label>Nama Warna <span className="text-red-700 dark:text-red-400">*</span></Label>
