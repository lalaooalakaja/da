    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {[
          ...
          <div key={c.label} className={`bg-foreground/[0.03] border border-${c.color}-500/20 rounded-2xl p-4`}>
                ...
                <div className="bg-gradient-to-br from-violet-500/10 to-fuchsia-500/10 border border-violet-300 dark:border-violet-500/20 rounded-xl p-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className={`text-[10px] px-2 py-0.5 rounded-full ${
                      ...
                      'bg-muted dark:bg-zinc-500/20 text-muted-foreground/60 dark:text-zinc-400'
                    }`}>
