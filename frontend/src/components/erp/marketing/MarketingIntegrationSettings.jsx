...
function StatusBadge({ connected }) {
  return connected ? (
    ...
    <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium bg-muted text-muted-foreground/80 dark:bg-gray-800 dark:text-gray-400">
