...
const SLA_CONFIG = {
  ...
  resolved: { label: 'Selesai',   color: 'bg-muted text-muted-foreground/60 dark:bg-gray-800/50 dark:text-gray-400',            dot: 'bg-muted' },
};
...
const STATUS_CONFIG = {
  ...
  closed:      { label: 'Ditutup',    color: 'bg-muted text-muted-foreground/60 dark:bg-gray-800/50 dark:text-gray-400',        icon: XCircle },
};
...
const SEVERITY_CONFIG = {
  ...
  low:      { label: 'Rendah',   color: 'text-muted-foreground/80',   bg: 'bg-muted' },
};
