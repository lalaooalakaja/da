...
const STATUS_CONFIG = {
  draft:     { label: 'Draft',     color: 'bg-muted text-muted-foreground/60 dark:bg-gray-800 dark:text-gray-300', icon: AlertCircle },
  ...
  return (
    <Card className={`${bg} border-0`}>
      <CardContent className="p-4 flex items-center gap-3">
        <div className={`p-2 rounded-lg bg-foreground/[0.06]0 dark:bg-black/20`}>
                              ...
                              {entries.slice(0, 3).map(e => (
                                <div key={e.id}
                                  className={`text-xs px-1 py-0.5 rounded truncate cursor-pointer hover:opacity-80 ${
                                    ...
                                    'bg-muted text-muted-foreground/60 dark:bg-gray-800'
                                  }`}
