...
const DIR_CONFIG = {
  ...
  hold:     { icon: Target,    color: 'text-muted-foreground/60',   bg: 'bg-muted dark:bg-slate-800/50' }
};
...
const AB_STATUS = {
  draft:     { label: 'Draft',    color: 'bg-muted text-muted-foreground/50 dark:bg-slate-800 dark:text-foreground/70' },
            ...
            <div className="flex items-center gap-4 flex-1">
              ...
              <div>
                <div className="flex items-center gap-3">
                  ...
                  />
                  <Badge className={isEnabled ? 'bg-emerald-100 text-emerald-700' : 'bg-muted text-muted-foreground/50'}>
                      ...
                      <tr key={ev.id} className="hover:bg-muted/20">
                        ...
                        <td className="px-3 py-1.5">
                          <Badge className={`text-xs ${
                            ...
                            ev.event_type === 'reject' ? 'bg-red-100 text-red-700' : 'bg-muted text-muted-foreground/50'
                          }`}>{ev.event_type}</Badge>
                        </td>
