...
const URGENCY_CONFIG = {
  ...
  low:    { label: 'Rendah', color: 'bg-muted text-muted-foreground/50 dark:bg-slate-800 dark:text-foreground/70', dot: 'bg-muted' }
};
                          ...
                          <div key={i} className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <Badge className={`text-xs ${
                                ...
                                t.impact === 'medium' ? 'bg-amber-100 text-amber-700' : 'bg-muted text-muted-foreground/50'
                              }`}>{t.impact}</Badge>
                            </div>
                          </div>
                        ))}
