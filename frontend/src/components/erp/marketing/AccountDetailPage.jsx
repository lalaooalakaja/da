          ...
          <div key={c.id} className="rounded-lg border bg-card p-3" data-testid={`creator-card-${c.id}`}>
            <div className="flex items-center gap-2 mb-2">
              ...
              <div className={`text-[10px] ml-auto shrink-0 px-1.5 py-0.5 rounded-full border font-medium ${
                c.status === 'active' ? 'bg-emerald-100 dark:bg-emerald-500/10 text-emerald-600 border-emerald-400 dark:border-emerald-500/30' : 'bg-muted dark:bg-gray-500/10 text-muted-foreground/80 border-border dark:border-gray-500/30'
              }`}>{c.status}</div>
            </div>
        ...
        <div key={h.id} className="rounded-lg border bg-card p-3" data-testid={`host-card-${h.id}`}>
          <div className="flex items-center justify-between mb-2">
            ...
            <Badge variant="outline" className={`text-[10px] ${
              h.status === 'active' ? 'bg-emerald-100 dark:bg-emerald-500/10 text-emerald-600 border-emerald-400 dark:border-emerald-500/30' : 'bg-muted dark:bg-gray-500/10 text-muted-foreground/80 border-border dark:border-gray-500/30'
            }`}>{h.status}</Badge>
          </div>
