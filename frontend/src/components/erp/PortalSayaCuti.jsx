...
const STATUS_CFG = {
  ...
  cancelled:        { label: 'Dibatalkan', icon: X,           cls: 'bg-muted text-muted-foreground/50 border-border dark:bg-slate-800/30 dark:text-muted-foreground dark:border-slate-600' },
};
