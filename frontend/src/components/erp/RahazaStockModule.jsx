    ...
    <div className="space-y-5" data-testid="rahaza-stock-page">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        <button
          ...
          className={`text-xs px-2.5 py-1 rounded-lg border transition-colors ${filterLocation === '' ? 'bg-foreground/[0.15] border-foreground/[0.03]0 text-foreground' : 'bg-foreground/5 border-foreground/10 text-foreground/50 hover:bg-foreground/10'}`}
        >
          Semua
        </button>
